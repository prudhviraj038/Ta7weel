...
public class LineChartActivity extends DemoBase implements SeekBar.OnSeekBarChangeListener,
    ...
    private TextView tvX, tvY, customize_chart;

    public static LineChartActivity newInstance(int someInt) {
...
//        setContentView(R.layout.activity_linechart);
        ...
        customize_chart = (TextView)view.findViewById(R.id.customize_chart);
        customize_chart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                PopupMenu popup = new PopupMenu(getContext(), customize_chart);
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
          ...
          //  set1.setDrawIcons(false);
            ...
            set1.enableDashedLine(0f, 5f, 0f);
